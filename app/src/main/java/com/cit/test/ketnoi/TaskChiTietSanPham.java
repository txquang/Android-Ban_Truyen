...
public class TaskChiTietSanPham extends AsyncTask<String,String,String> {

    String URL;
    private NetworkResponseListener networkResponseListener;
    public TaskChiTietSanPham(NetworkResponseListener networkResponseListener, String URL){
        this.URL=URL;
    ...
    protected String doInBackground(String... strings) {
        ...
        client.newBuilder().connectTimeout(2000, TimeUnit.SECONDS)
